...
| ⚡ | [hammerspoon-config](https://github.com/XiaokunDuan/hammerspoon-config) | A personal macOS automation stack for real workflows across window control, app launching, and everyday desktop automation.<br>一套围绕真实工作流整理的 macOS 自动化配置，覆盖窗口控制、应用切换和日常桌面自动化。 |
